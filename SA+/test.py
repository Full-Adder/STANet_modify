...
def get_arguments():
    ...
    parser.add_argument("--img_dir2", type=str, default='/home/omnisky/data/wgt/train/')
...
def get_model(args):
    ...
    checkpoint = torch.load('./runs/pascal2/test/model/43.pth')
...
def test(args):
    ...
    with torch.no_grad():
        for idx_test, dat_test in enumerate(val_loader):
            ...
            x11,x1, x22,x2, x33,x3, map1, map_all = model(1, img_name1, img_name2, img_name3, img1, img2, img3, aud1, aud2, aud3, 1, label1, 1)
