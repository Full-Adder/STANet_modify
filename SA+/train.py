...
def train(args, save_index):
    ...
    while current_epoch < total_epoch:
        ...
        for idx, dat in enumerate(train_loader):
            ...
            img_name1, img1, aud1, inda1, label1, img_name2, img2, aud2, inda2, label2, img_name3, img3, aud3, inda3, label3 = dat
            ...
            x11,x1, x22,x2, x33,x3, map1, map_all = model(idx, img_name1, img_name2, img_name3, img1, img2, img3, aud1, aud2, aud3, current_epoch, label1, index)
            index += 1
