...
class VOCDatasetT(Dataset):
    ...
    def __getitem__(self, idx):    
        ...
        for mm in range(-1, 2):
            img_name = os.path.join(img_la[2], img_la[3], img_la[4], "%04d"%(int(img_la[5][:-4])+mm)+'.jpg')
        ...
        for hh in range(0, 2):
            ...
            for ii in range(-1,2):
                pick_path = os.path.join(img_la[2], img_la[3], pathname[aa][0], self.figs_list[inda][aa][bb+ii][:-4]+'.jpg')
        ...
        label[inda] = 1
        return image_names[0], images[0], image_names[1], images[1], \
            image_names[2], images[2], image_names[3], images[3], \
            image_names[4], images[4], image_names[5], images[5], \
            image_names[6], images[6], image_names[7], images[7], \
            image_names[8], images[8], inda, label\
